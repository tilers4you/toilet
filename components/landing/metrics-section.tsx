...
const metrics = [
  { value: 3, suffix: "", prefix: "", label: "Core services: repair, replacement, installation" },
  { value: 4, suffix: "", prefix: "", label: "High-intent pages planned for local SEO" },
  { value: 1, suffix: ".28", prefix: "", label: "GPF WaterSense toilet target for efficient upgrades" },
  { value: 24, suffix: "h", prefix: "", label: "Urgent response messaging for active leaks and overflows" },
];
